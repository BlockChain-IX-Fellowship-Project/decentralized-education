        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-bold">De-Education Platform</h2>
            </div>
            <p className="text-gray-300 text-lg mb-8 leading-relaxed">
              Learn blockchain technology and earn tokens while building your skills in the decentralized future. Join thousands of learners worldwide.
            </p>
             {/* Social Links */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Browse Courses</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Certificates</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Community</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Leaderboard</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 De-Education Platform. All rights reserved.
            </p>
            <div className="flex items-center space-x-4 mt-4 md:mt-0">
              <span className="text-gray-400 text-sm">Built with</span>
              <div className="flex items-center space-x-1">
                <span className="text-red-500">♥</span>
                <span className="text-gray-400 text-sm">on Blockchain</span>
              </div>
            </div>
          </div>
        </div>
