...
import { updateSectionProgress } from "../utils/quizApi";
...
export default function SectionQuiz() {
  ...
  if (!section) return <div className="text-center py-10">Loading...</div>;
        ...
        {!showResults ? (
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="text-sm font-semibold text-gray-600 bg-blue-100 px-3 py-1 rounded-full shadow">
            ...
            <form
              ...
              onSubmit={(e) => {
                e.preventDefault();
                if (userAnswers[currentQ]) handleAnswer(userAnswers[currentQ]);
              }}
            >
              ...
              <div className="flex justify-between mt-6">
                ...
                <button
                  ...
                  className={`bg-blue-600 text-white px-5 py-2 rounded font-semibold ${
                    !userAnswers[currentQ] ? "opacity-60 cursor-not-allowed" : ""
                  }`}
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <div className="flex flex-col items-center mb-6">
              ...
              <h2 className="text-2xl font-bold mb-2 text-gray-900">
                {score === quiz.length ? "Quiz Passed" : "Quiz Failed"}
              </h2>
              ...
              {quiz.map((q, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {correct ? "✔️" : "❌"} {q.question}
                    </div>
                    <div className="text-sm mb-1">
                      Your answer: <span className="font-medium">{userAnswers[idx]}</span>
                    </div>
                    {!correct && (
            ...
            <div className="flex gap-4 justify-center">
              <button
                className="bg-gray-900 text-white px-5 py-2 rounded font-semibold"
